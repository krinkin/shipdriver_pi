...
int MarineNaviPi::Init(void) {
  ...
  return (WANTS_OVERLAY_CALLBACK | WANTS_OPENGL_OVERLAY_CALLBACK | WANTS_TOOLBAR_CALLBACK 
          | INSTALLS_TOOLBAR_TOOL | WANTS_PLUGIN_MESSAGING | WANTS_VECTOR_CHART_OBJECT_INFO);
